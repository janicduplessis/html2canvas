...
var CanvasRenderer = /** @class */ (function () {
    ...
    CanvasRenderer.prototype.renderTextWithLetterSpacing = function (text, styles) {
        var _this = this;
        styles.paintOrder.forEach(function (layer) {
            switch (layer) {
                case 1 /* FILL */:
                    _this.renderWithLetterSpacing(text, styles.letterSpacing, function (t, x, y) {
                ...
                case 2 /* STROKE */:
                    if (styles.textStrokeWidth > 0) {
                        var initialStrokeStyle = _this.ctx.strokeStyle;
                        var intialLineWidth = _this.ctx.lineWidth;
                        _this.ctx.strokeStyle = styles.textStrokeColor.toString();
                        _this.ctx.lineWidth = styles.textStrokeWidth;
                        _this.renderWithLetterSpacing(text, styles.letterSpacing, function (t, x, y) {
                            _this.ctx.strokeText(t, x, y);
                        });
                        _this.ctx.strokeStyle = initialStrokeStyle;
                        _this.ctx.lineWidth = intialLineWidth;
                    }
                    break;
                default:
                    break;
    ...
    CanvasRenderer.prototype.renderWithLetterSpacing = function (text, letterSpacing, render) {
        var _this = this;
        if (letterSpacing === 0) {
                ...
                switch (_b.label) {
                    ...
                    case 14:
                        ...
                        if (isTextInputElement(container) && container.value.length) {
                            ...
                            this.ctx.clip();
                            this.renderTextWithLetterSpacing(new text_1.TextBounds(container.value, textBounds), styles);
                            this.ctx.restore();
                            this.ctx.textBaseline = 'bottom';
                    ...
                    case 19:
                        if (paint.listValue && container.styles.listStyleType !== list_style_type_1.LIST_STYLE_TYPE.NONE) {
                            ...
                            this.renderTextWithLetterSpacing(new text_1.TextBounds(paint.listValue, bounds), styles);
                            this.ctx.textBaseline = 'bottom';
                            this.ctx.textAlign = 'left';
                        }
                        _b.label = 20;
